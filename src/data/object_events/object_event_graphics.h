...
const u16 gObjectEventPic_Paras[] = INCBIN_U16("graphics/object_events/pics/pokemon/paras.4bpp");
const u16 gObjectEventPal_Paras[] = INCBIN_U16("graphics/object_events/palettes/paras.gbapal");
